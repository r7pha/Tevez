...
function library:CreateSettingsTab(menu)
    ...
    local creditsSection = settingsTab:AddSection('Créditos', 2);
    creditsSection:AddSeparator({text = 'Desenvolvedor'});
    creditsSection:AddText({text = "Discord: unsunrise7"})
    ...
    mainSection:AddToggle({text = 'Desabilitar o movimento se estiver aberto', flag = 'disablemenumovement', callback = function(bool)
    ...
    mainSection:AddButton({text = 'Reentrar no servidor.', confirm = true, callback = function()
